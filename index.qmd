---
title: "Analyse des données météo"
author: "Adem GHARRAS"
format: 
  html:
    theme: cosmo
...
![Carte du Texas](https://upload.wikimedia.org/wikipedia/commons/9/91/Flag-map_of_Texas.svg)\
...
-   Le graphique met en évidence une alternance de longues périodes sèches et d’épisodes de fortes précipitations, caractéristique des climats semi-arides.
...
::: callout-note
Les mois estivaux présentent une variabilité plus élevée des précipitations, suggérant une saisonnalité marquée.
:::
...
::: callout-warning
Le test de Shapiro-Wilk rejette l’hypothèse de normalité des précipitations. Des tests non paramétriques sont donc plus appropriés.
:::
...
::: callout-note
Le test de Kruskal-Wallis indique une différence significative des précipitations selon les mois de l’année.
:::
...
::: callout-note
Les corrélations de Spearman entre précipitations et températures sont faibles, confirmant l’absence de relation linéaire directe.
:::
...
::: callout-note
Les événements de précipitations extrêmes sont majoritairement concentrés durant la période estivale (mai à septembre).
:::
...
::: callout-note
La régression linéaire ne révèle pas de relation significative entre les températures apparentes minimale et maximale, en partie à cause du nombre élevé de valeurs manquantes.
:::

## Conclusion

Cette étude met en évidence une structure saisonnière marquée des précipitations pour la station US1TXGS0046. Bien que les corrélations linéaires soient faibles, l’analyse non paramétrique révèle une concentration des événements extrêmes durant les mois estivaux.

Ces résultats soulignent l’importance d’approches exploratoires et statistiques adaptées pour l’analyse des données climatiques.